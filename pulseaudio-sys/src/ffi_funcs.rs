...
mod static_fns {
    ...
    extern "C" {
        ...
        pub fn pa_context_get_sink_info_list(c: *mut pa_context,
                                             ...
                                             userdata: *mut c_void)
                                             -> *mut pa_operation;
        pub fn pa_context_get_sink_input_info(c: *mut pa_context,
                                              idx: u32,
        ...
        pub fn pa_context_rttime_new(c: *mut pa_context,
                                     usec: pa_usec_t,
        ...
        pub fn pa_mainloop_api_once(m: *mut pa_mainloop_api,
                                    callback: Option<unsafe extern "C" fn(m: *mut pa_mainloop_api, userdata: *mut c_void)>,
                                    userdata: *mut c_void);
        ...
        pub fn pa_stream_is_suspended(s: *mut pa_stream) -> c_int;
        pub fn pa_stream_is_corked(s: *mut pa_stream) -> c_int;
        ...
        pub fn pa_stream_get_latency(s: *mut pa_stream, r_usec: *mut pa_usec_t, negative: *mut c_int) -> c_int;
        ...
        pub fn pa_stream_get_context(s: *mut pa_stream) -> *mut pa_context;
        pub fn pa_stream_get_time(s: *mut pa_stream, r_usec: *mut pa_usec_t) -> c_int;
...
mod dynamic_fns {
    ...
    #[inline]
    pub unsafe fn pa_context_get_server_info(c: *mut pa_context,
                                             cb: pa_server_info_cb_t,
                                             userdata: *mut c_void)
                                             -> *mut pa_operation {
        (::std::mem::transmute::<_,
                                 extern "C" fn(*mut pa_context, pa_server_info_cb_t, *mut c_void)
    ...
    #[inline]
    pub unsafe fn pa_context_get_sink_info_by_name(c: *mut pa_context,
                                                   name: *const c_char,
                                                   cb: pa_sink_info_cb_t,
                                                   userdata: *mut c_void)
                                                   -> *mut pa_operation {
    ...
    #[inline]
    pub unsafe fn pa_context_get_sink_info_list(c: *mut pa_context,
                                                cb: pa_sink_info_cb_t,
                                                userdata: *mut c_void)
                                                -> *mut pa_operation {
        (::std::mem::transmute::<_,
                                 extern "C" fn(*mut pa_context, pa_sink_info_cb_t, *mut c_void)
    ...
    #[inline]
    pub unsafe fn pa_context_get_sink_input_info(c: *mut pa_context,
                                                 idx: u32,
                                                 cb: pa_sink_input_info_cb_t,
                                                 userdata: *mut c_void)
                                                 -> *mut pa_operation {
        (::std::mem::transmute::<_,
                                 extern "C" fn(*mut pa_context, u32, pa_sink_input_info_cb_t, *mut c_void)
    ...
    #[inline]
    pub unsafe fn pa_context_get_source_info_list(c: *mut pa_context,
                                                  cb: pa_source_info_cb_t,
                                                  userdata: *mut c_void)
                                                  -> *mut pa_operation {
        (::std::mem::transmute::<_,
                                 extern "C" fn(*mut pa_context, pa_source_info_cb_t, *mut c_void)
                                               -> *mut pa_operation>(PA_CONTEXT_GET_SOURCE_INFO_LIST))(c, cb, userdata)
    }

    static mut PA_CONTEXT_GET_STATE: *mut ::libc::c_void = 0 as *mut _;
    #[inline]
    pub unsafe fn pa_context_get_state(c: *mut pa_context) -> pa_context_state_t {
        (::std::mem::transmute::<_, extern "C" fn(*mut pa_context) -> pa_context_state_t>(PA_CONTEXT_GET_STATE))(c)
    }
    ...
    #[inline]
    pub unsafe fn pa_context_rttime_new(c: *mut pa_context,
                                        usec: pa_usec_t,
                                        cb: pa_time_event_cb_t,
                                        userdata: *mut c_void)
                                        -> *mut pa_time_event {
    ...
    #[inline]
    pub unsafe fn pa_strerror(error: c_int) -> *const c_char {
        (::std::mem::transmute::<_, extern "C" fn(c_int) -> *const c_char>(PA_STRERROR))(error)
    }
    ...
    #[inline]
    pub unsafe fn pa_operation_get_state(o: *mut pa_operation) -> pa_operation_state_t {
        (::std::mem::transmute::<_,
    ...
    #[inline]
    pub unsafe fn pa_stream_is_suspended(s: *mut pa_stream) -> c_int {
        (::std::mem::transmute::<_, extern "C" fn(*mut pa_stream) -> c_int>(PA_STREAM_IS_SUSPENDED))(s)
    }

    static mut PA_STREAM_IS_CORKED: *mut ::libc::c_void = 0 as *mut _;
    #[inline]
    pub unsafe fn pa_stream_is_corked(s: *mut pa_stream) -> c_int {
        (::std::mem::transmute::<_, extern "C" fn(*mut pa_stream) -> c_int>(PA_STREAM_IS_CORKED))(s)
    }
    ...
    #[inline]
    pub unsafe fn pa_stream_get_buffer_attr(s: *mut pa_stream) -> *const pa_buffer_attr {
        (::std::mem::transmute::<_,
                                 extern "C" fn(*mut pa_stream)
    ...
    #[inline]
    pub unsafe fn pa_stream_get_channel_map(s: *mut pa_stream) -> *const pa_channel_map {
        (::std::mem::transmute::<_,
                                 extern "C" fn(*mut pa_stream)
    ...
    #[inline]
    pub unsafe fn pa_stream_get_device_name(s: *mut pa_stream) -> *const c_char {
        (::std::mem::transmute::<_, extern "C" fn(*mut pa_stream) -> *const c_char>(PA_STREAM_GET_DEVICE_NAME))(s)
    }

    static mut PA_STREAM_GET_INDEX: *mut ::libc::c_void = 0 as *mut _;
    #[inline]
    pub unsafe fn pa_stream_get_index(s: *mut pa_stream) -> u32 {
        (::std::mem::transmute::<_, extern "C" fn(*mut pa_stream) -> u32>(PA_STREAM_GET_INDEX))(s)
    }

    static mut PA_STREAM_GET_LATENCY: *mut ::libc::c_void = 0 as *mut _;
    #[inline]
    pub unsafe fn pa_stream_get_latency(s: *mut pa_stream, r_usec: *mut pa_usec_t, negative: *mut c_int) -> c_int {
        (::std::mem::transmute::<_,
                                 extern "C" fn(*mut pa_stream,
                                               *mut pa_usec_t,
                                               *mut c_int)
    ...
    #[inline]
    pub unsafe fn pa_stream_get_sample_spec(s: *mut pa_stream) -> *const pa_sample_spec {
        (::std::mem::transmute::<_,
                                 extern "C" fn(*mut pa_stream)
    ...
    #[inline]
    pub unsafe fn pa_stream_get_state(p: *mut pa_stream) -> pa_stream_state_t {
        (::std::mem::transmute::<_, extern "C" fn(*mut pa_stream) -> pa_stream_state_t>(PA_STREAM_GET_STATE))(p)
    }

    static mut PA_STREAM_GET_CONTEXT: *mut ::libc::c_void = 0 as *mut _;
    #[inline]
    pub unsafe fn pa_stream_get_context(s: *mut pa_stream) -> *mut pa_context {
        (::std::mem::transmute::<_, extern "C" fn(*mut pa_stream) -> *mut pa_context>(PA_STREAM_GET_CONTEXT))(s)
    }

    static mut PA_STREAM_GET_TIME: *mut ::libc::c_void = 0 as *mut _;
    #[inline]
    pub unsafe fn pa_stream_get_time(s: *mut pa_stream, r_usec: *mut pa_usec_t) -> c_int {
        (::std::mem::transmute::<_,
                                 extern "C" fn(*mut pa_stream, *mut pa_usec_t)
    ...
    #[inline]
    pub unsafe fn pa_stream_readable_size(p: *mut pa_stream) -> usize {
        (::std::mem::transmute::<_, extern "C" fn(*mut pa_stream) -> usize>(PA_STREAM_READABLE_SIZE))(p)
    }
    ...
    #[inline]
    pub unsafe fn pa_stream_writable_size(p: *mut pa_stream) -> usize {
        (::std::mem::transmute::<_, extern "C" fn(*mut pa_stream) -> usize>(PA_STREAM_WRITABLE_SIZE))(p)
    }
